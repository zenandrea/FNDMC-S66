...
# 4.92	-5.01	4.915	4.982	4.979	4.946	-4.991


Eb_ref = {}
Eb_ref['Hobza']            = -4.92
Eb_ref['Hobza rev']        = -5.01
Eb_ref['Martin newBronze'] = -4.915
Eb_ref['Martin Silver']    = -4.982
Eb_ref['Martin PCCP2022']  = -4.946
Eb_ref['Nagy 14k-GOLD']    = -4.991
...
for method in methods:
        ...
        if os.path.isfile( csvfile ):
            ...
            if makefit:
                ...
                plt.plot( xlinspace, funlinspace, '--', color=Dcolor[method] )
                print( f'popt = {popt}' )
                print( f'pcov = {pcov}\n' )
